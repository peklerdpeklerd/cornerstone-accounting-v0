...
export function LeadershipSection() {
  ...
  return (
    <section
      ...
      className="relative w-full overflow-hidden border-y border-border/70 bg-[#f5f4f1]"
    >
      <div
        ref={introRef}
        className="relative mx-auto grid min-h-[calc(100svh-var(--header-height))] w-full max-w-7xl items-center gap-12 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-[1fr_minmax(330px,410px)] lg:gap-16 lg:px-10 lg:py-16 xl:gap-24"
      >
        <p
          aria-hidden="true"
          className={`pointer-events-none absolute top-[9%] left-1/2 -translate-x-1/2 text-[clamp(4.5rem,12vw,10rem)] leading-none font-bold tracking-[-0.07em] text-[#263246]/[0.035] uppercase transition-[opacity,transform] duration-1000 ease-out ${
            introVisible
        ...
        <div className="relative z-10 max-w-2xl">
          <div
            className={`flex items-center gap-4 transition-[opacity,transform] delay-100 duration-700 ease-out ${
              introVisible
                ? "translate-y-0 opacity-100"
          ...
          <div className="mt-7 overflow-hidden">
            <p
              className={`text-xl font-medium text-muted-foreground transition-transform delay-200 duration-700 ease-out sm:text-2xl ${
                introVisible ? "translate-y-0" : "translate-y-full"
              }`}
            >
              Introducing
            </p>
          ...
          <div className="mt-1 overflow-hidden pb-2">
            <h2
              ...
              className={`max-w-3xl text-5xl leading-[0.98] font-bold tracking-[-0.045em] text-balance text-primary transition-transform delay-300 duration-1000 ease-out sm:text-6xl lg:text-[4.6rem] ${
                introVisible ? "translate-y-0" : "translate-y-[110%]"
              }`}
            >
          ...
          <div
            className={`mt-6 transition-[opacity,transform] delay-500 duration-700 ease-out ${
              introVisible
                ? "translate-y-0 opacity-100"
          ...
          <a
            ...
            className={`group mt-9 inline-flex items-center gap-3 text-xs font-semibold tracking-[0.16em] text-primary uppercase transition-[opacity,transform,color] delay-700 duration-700 ease-out hover:text-accent ${
              introVisible
                ? "translate-y-0 opacity-100"
                : "translate-y-5 opacity-0"
            }`}
        ...
        <div
          className={`relative z-10 mx-auto w-full max-w-[350px] transition-[opacity,transform] delay-300 duration-1000 ease-out sm:max-w-[380px] lg:max-w-[410px] ${
            introVisible
              ? "translate-x-0 translate-y-0 scale-100 opacity-100"
              : "translate-x-12 translate-y-10 scale-[0.96] opacity-0"
          }`}
        >
          <div
            aria-hidden="true"
          ...
          <div
            aria-hidden="true"
            className={`absolute top-0 -left-3 h-full w-px origin-top bg-primary/50 transition-transform delay-700 duration-1000 ease-out sm:-left-5 ${
        ...
        <div
          aria-hidden="true"
          className={`absolute bottom-0 left-1/2 h-14 w-px origin-bottom bg-primary/25 transition-transform delay-700 duration-1000 ease-out ${
            introVisible ? "scale-y-100" : "scale-y-0"
          }`}
        />
      </div>
